...
const data: CompareData = {
  ...
  drugs: [
    ...
    { generic: 'セフェピム (CFPM)', brand: 'マキシピーム', specs: '注射 0.5g/1g/2g', indication: '発熱性好中球減少症、院内肺炎、緑膿菌感染', halfLife: '約2時間', metabolism: '腎排泄 85%', renalAdjust: 'CCr < 50: 減量。特に腎障害で脳症リスク上昇', features: '第4世代。グラム陰性桿菌（緑膿菌含む）＋グラム陽性球菌の両方にバランスよく有効。AmpC型βラクタマーゼに安定。腎障害での蓄積で脳症（意識障害・痙攣）のリスク — 血中濃度モニタリング推奨', contraindication: 'セフェム系アレルギー', evidence: '' },
  ],
  seoContent: [
