...
const data: CompareData = {
  ...
  drugs: [
    ...
    { generic: 'デュロキセチン', brand: 'サインバルタ', specs: '20mg/30mg/60mgカプセル', indication: 'うつ病、糖尿病性神経障害・線維筋痛症・慢性腰痛の疼痛、変形性関節症の疼痛', halfLife: '約12時間', metabolism: 'CYP1A2（主）/2D6', renalAdjust: 'CCr < 30: 推奨されない', features: 'SNRI。疼痛適応が豊富（糖尿病性神経障害・線維筋痛症・腰痛・OA）。下行性疼痛抑制系の活性化。CYP2D6の中等度阻害。肝障害で血中濃度上昇', contraindication: 'MAO阻害薬併用、高度腎障害、高度肝障害、尿閉', evidence: '' },
