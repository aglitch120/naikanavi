...
- [ ] **病棟TODO オンボーディングチュートリアル**（ハイライト形式）
- [ ] **ICU γ計算アプリ**（昇圧剤/強心薬/鎮静剤/降圧剤のγ計算、希釈濃度タップ or 手動入力）
- [ ] **ER主訴追加 15+**（めまい、頭痛、腰背部痛、動悸、咳・喀痰、下痢、しびれ、麻痺、悪心嘔吐、咽頭痛、発熱(院内)、血痰喀血、吐血下血、けいれん、ショック、気管挿管、人工呼吸管理）
- [ ] **検査読影追加**（エコー(心臓)、CT、MRI、血液検査、尿検査、頸動脈エコー）
- [ ] **抗菌薬ガイド新規作成**
- [ ] **Hokuto掲載計算ツール追加**（未実装分）
