...
const data: CompareData = {
  ...
  drugs: [
    ...
    { generic: 'ドチヌラド', brand: 'ユリス', specs: '0.5mg/1mg/2mg', indication: '痛風、高尿酸血症', halfLife: '約10時間', metabolism: 'グルクロン酸抱合（BCRP・MRP4阻害で腎尿細管からの尿酸再吸収を阻害）', renalAdjust: '重度腎障害: 慎重投与', features: '選択的URAT1阻害薬。ベンズブロマロンより肝障害リスクが低い。新世代の尿酸排泄促進薬。0.5mgから漸増。尿アルカリ化推奨', contraindication: '重篤な腎障害', evidence: '' },
  ],
  seoContent: [
