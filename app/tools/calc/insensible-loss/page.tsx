...
export default function InsensibleLossPage() {
  ...
  return (
    <CalculatorLayout slug={toolDef.slug} title={toolDef.name} titleEn={toolDef.nameEn} description={toolDef.description}
      ...
      explanation={<div className="space-y-2 text-sm text-muted"><p><strong className="text-tx">計算式:</strong> 不感蒸泄 = 15 mL/kg/日 ×（1 + 0.15 ×（体温−37））</p><p>皮膚(2/3)と呼気(1/3)からの水分喪失。体温1℃上昇ごとに約15%増加。</p><p>人工呼吸中は呼気からの蒸泄が減少（加温加湿回路使用時）。</p></div>}
