...
export default function WestleyPage(){
  ...
  return(
    <CalculatorLayout slug={toolDef.slug} title={toolDef.name} titleEn={toolDef.nameEn} description={toolDef.description}
      ...
      explanation={<section className="space-y-4 text-sm text-muted"><h2 className="text-base font-bold text-tx">Westleyクループスコアとは</h2><p>クループ症候群の重症度を5項目（stridor/陥没呼吸/空気流入/チアノーゼ/意識）で評価。≦2軽症、3-7中等症、≧8重症。デキサメタゾン0.6mg/kg経口/筋注が全例に推奨。</p></section>}
