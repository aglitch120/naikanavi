...
const drugs=[
  ...
  {cat:'糖尿病治療薬',items:[{name:'メトホルミン',stop:'手術当日朝から中止',note:'腎機能に応じて術後再開'},{name:'SGLT2阻害薬',stop:'3-5日前（大手術では4-5日前）',note:'周術期DKAリスク'},{name:'SU剤/グリニド',stop:'手術当日朝から中止',note:'低血糖リスク'},{name:'インスリン',stop:'投与量調整（中止しない）',note:'基礎インスリンは50-80%に減量'}]},
