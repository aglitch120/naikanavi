...
const data: CompareData = {
  ...
  drugs: [
    ...
    { generic: 'レンボレキサント', brand: 'デエビゴ', specs: '2.5mg/5mg/10mg', indication: '不眠症', halfLife: '約31-50時間', metabolism: 'CYP3A4（主）', renalAdjust: '重度肝障害: 非推奨', features: 'オレキシン受容体拮抗薬（DORA）。スボレキサントより入眠効果が強いとのデータ。依存性なし。翌日への持ち越しに注意（半減期長い）。2.5mgから開始可能', contraindication: '重度肝障害', evidence: 'SUNRISE試験（高齢者でのエビデンス）' },
  ...
  seoContent: [
    { heading: '睡眠薬の作用機序別分類', text: '現在の睡眠薬は4つの作用機序に分類されます。BZD系/非BZD系（GABA-A受容体作動）、オレキシン受容体拮抗薬（DORA: スボレキサント・レンボレキサント）、メラトニン受容体作動薬（ラメルテオン）です。近年は依存性の少ないDORA・メラトニン系が第一選択として推奨される傾向にあります。' },
    { heading: '高齢者の不眠治療', text: '高齢者ではBZD系睡眠薬による転倒・骨折・せん妄・認知機能低下のリスクが問題です。ガイドラインではオレキシン受容体拮抗薬またはラメルテオンを第一選択とし、BZD系は極力避けることが推奨されています。やむを得ず使用する場合は超短時間作用型を短期間に限定します。' },
