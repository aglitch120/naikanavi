    ...
    <main className="max-w-2xl mx-auto px-4 py-12">
      ...
      <section className="space-y-6 text-sm leading-relaxed text-tx">
        ...
        <div>
          ...
          <p>
            <span className="font-bold">iwor</span>（イウォル）は、アイヌ語で人が自然から恵みを受け取る場所を指す言葉です。
            人が健やかに生きるために必要なものが、すべてそこにある。
          </p>
          <p className="mt-2 text-muted">
            医師が患者の健康を守り続けるためには、医師自身を支える仕組みが必要です。
            臨床の現場で必要なツールや知識が、いつでも手の届く場所にある。
            そんな存在でありたいという思いを込めて名付けました。
          </p>
        </div>
