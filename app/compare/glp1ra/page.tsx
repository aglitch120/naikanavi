...
const data: CompareData = {
  ...
  drugs: [
    ...
    { generic: 'エキセナチド', brand: 'バイエッタ/ビデュリオン', specs: '皮下注', indication: '2型糖尿病', halfLife: '約2.4時間（徐放製剤は数週間）', metabolism: '腎排泄（GFR依存）', renalAdjust: 'CCr < 30: 使用非推奨', features: '1日2回（バイエッタ）or 週1回（ビデュリオン・徐放）。世界初のGLP-1RA。腎排泄型なので腎機能低下例は注意。注射部位結節（徐放剤）', contraindication: '重篤な腎障害、甲状腺髄様癌の既往/家族歴', evidence: 'EXSCEL試験' },
  ],
  seoContent: [
